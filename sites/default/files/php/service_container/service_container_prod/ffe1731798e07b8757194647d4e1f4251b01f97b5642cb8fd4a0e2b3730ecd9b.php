...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'authentication.basic_auth' => 'getAuthentication_BasicAuthService',
            ...
            'hal.subscriber' => 'getHal_SubscriberService',
            ...
            'restui.manager' => 'getRestui_ManagerService',
    ...
    {
        return $this->services['access_check.rest.csrf'] = new \Drupal\rest\Access\CSRFAccessCheck();
    }
    ...
    protected function getAccessManagerService()
    {
        ...
        $instance->addCheckService('access_check.rest.csrf', 'access', array());
    ...
    /**
     * Gets the 'authentication.basic_auth' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getAuthentication_BasicAuthService()
    {
        return $this->services['authentication.basic_auth'] = new \Drupal\basic_auth\Authentication\Provider\BasicAuth($this->get('config.factory'), $this->get('user.auth'), $this->get('flood'), $this->get('entity.manager'));
    }
    ...
    {
        return $this->services['cache.rest'] = $this->get('cache_factory')->get('rest');
    }
    ...
    {
        return $this->services['container.namespaces'] = new \ArrayObject(array('Drupal\\block' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/block/src', 'Drupal\\basic_auth' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/basic_auth/src', 'Drupal\\breakpoint' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/breakpoint/src', 'Drupal\\config' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/config/src', 'Drupal\\datetime' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/datetime/src', 'Drupal\\dblog' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/dblog/src', 'Drupal\\entity' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/entity/src', 'Drupal\\entity_reference' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/entity_reference/src', 'Drupal\\field' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/field/src', 'Drupal\\field_ui' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/field_ui/src', 'Drupal\\file' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/file/src', 'Drupal\\filter' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/filter/src', 'Drupal\\hal' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/hal/src', 'Drupal\\image' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/image/src', 'Drupal\\link' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/link/src', 'Drupal\\menu_link' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/menu_link/src', 'Drupal\\node' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/node/src', 'Drupal\\options' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/options/src', 'Drupal\\rest' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/rest/src', 'Drupal\\restui' => '/Users/arvinsingla/Sites/dev/ibeacon/modules/contrib/restui/src', 'Drupal\\serialization' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/serialization/src', 'Drupal\\system' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/system/src', 'Drupal\\text' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/text/src', 'Drupal\\toolbar' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/toolbar/src', 'Drupal\\update' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/update/src', 'Drupal\\user' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/user/src', 'Drupal\\views' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/views/src', 'Drupal\\views_ui' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/views_ui/src', 'Drupal\\minimal' => '/Users/arvinsingla/Sites/dev/ibeacon/core/profiles/minimal/src', 'Drupal\\Core\\Entity' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/Entity', 'Drupal\\Core\\Field' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/Field', 'Drupal\\Core\\Mail' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/Mail', 'Drupal\\Core\\TypedData' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/TypedData', 'Drupal\\Core\\Validation' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/Validation', 'Drupal\\Component\\Annotation' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Component/Annotation'));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addSubscriberService('hal.subscriber', 'Drupal\\hal\\HalSubscriber');
        ...
        $instance->addSubscriberService('rest.resource_routes', 'Drupal\\rest\\Routing\\ResourceRoutes');
    ...
    /**
     * Gets the 'hal.subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Drupal\hal\HalSubscriber A Drupal\hal\HalSubscriber instance.
     */
    protected function getHal_SubscriberService()
    {
        return $this->services['hal.subscriber'] = new \Drupal\hal\HalSubscriber();
    }
    ...
    {
        return $this->services['module_handler'] = new \Drupal\Core\Extension\ModuleHandler(array('block' => array('type' => 'module', 'pathname' => 'core/modules/block/block.info.yml', 'filename' => 'block.module'), 'basic_auth' => array('type' => 'module', 'pathname' => 'core/modules/basic_auth/basic_auth.info.yml', 'filename' => 'basic_auth.module'), 'breakpoint' => array('type' => 'module', 'pathname' => 'core/modules/breakpoint/breakpoint.info.yml', 'filename' => 'breakpoint.module'), 'config' => array('type' => 'module', 'pathname' => 'core/modules/config/config.info.yml', 'filename' => 'config.module'), 'datetime' => array('type' => 'module', 'pathname' => 'core/modules/datetime/datetime.info.yml', 'filename' => 'datetime.module'), 'dblog' => array('type' => 'module', 'pathname' => 'core/modules/dblog/dblog.info.yml', 'filename' => 'dblog.module'), 'entity' => array('type' => 'module', 'pathname' => 'core/modules/entity/entity.info.yml', 'filename' => 'entity.module'), 'entity_reference' => array('type' => 'module', 'pathname' => 'core/modules/entity_reference/entity_reference.info.yml', 'filename' => 'entity_reference.module'), 'field' => array('type' => 'module', 'pathname' => 'core/modules/field/field.info.yml', 'filename' => 'field.module'), 'field_ui' => array('type' => 'module', 'pathname' => 'core/modules/field_ui/field_ui.info.yml', 'filename' => 'field_ui.module'), 'file' => array('type' => 'module', 'pathname' => 'core/modules/file/file.info.yml', 'filename' => 'file.module'), 'filter' => array('type' => 'module', 'pathname' => 'core/modules/filter/filter.info.yml', 'filename' => 'filter.module'), 'hal' => array('type' => 'module', 'pathname' => 'core/modules/hal/hal.info.yml', 'filename' => 'hal.module'), 'image' => array('type' => 'module', 'pathname' => 'core/modules/image/image.info.yml', 'filename' => 'image.module'), 'link' => array('type' => 'module', 'pathname' => 'core/modules/link/link.info.yml', 'filename' => 'link.module'), 'menu_link' => array('type' => 'module', 'pathname' => 'core/modules/menu_link/menu_link.info.yml', 'filename' => 'menu_link.module'), 'node' => array('type' => 'module', 'pathname' => 'core/modules/node/node.info.yml', 'filename' => 'node.module'), 'options' => array('type' => 'module', 'pathname' => 'core/modules/options/options.info.yml', 'filename' => 'options.module'), 'rest' => array('type' => 'module', 'pathname' => 'core/modules/rest/rest.info.yml', 'filename' => 'rest.module'), 'restui' => array('type' => 'module', 'pathname' => 'modules/contrib/restui/restui.info.yml', 'filename' => 'restui.module'), 'serialization' => array('type' => 'module', 'pathname' => 'core/modules/serialization/serialization.info.yml', 'filename' => 'serialization.module'), 'system' => array('type' => 'module', 'pathname' => 'core/modules/system/system.info.yml', 'filename' => 'system.module'), 'text' => array('type' => 'module', 'pathname' => 'core/modules/text/text.info.yml', 'filename' => 'text.module'), 'toolbar' => array('type' => 'module', 'pathname' => 'core/modules/toolbar/toolbar.info.yml', 'filename' => 'toolbar.module'), 'update' => array('type' => 'module', 'pathname' => 'core/modules/update/update.info.yml', 'filename' => 'update.module'), 'user' => array('type' => 'module', 'pathname' => 'core/modules/user/user.info.yml', 'filename' => 'user.module'), 'views' => array('type' => 'module', 'pathname' => 'core/modules/views/views.info.yml', 'filename' => 'views.module'), 'views_ui' => array('type' => 'module', 'pathname' => 'core/modules/views_ui/views_ui.info.yml', 'filename' => 'views_ui.module'), 'minimal' => array('type' => 'profile', 'pathname' => 'core/profiles/minimal/minimal.info.yml', 'filename' => 'minimal.profile')), $this->get('cache.bootstrap'));
    }
    ...
    {
        return $this->services['plugin.manager.rest'] = new \Drupal\rest\Plugin\Type\ResourcePluginManager($this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['rest.link_manager'] = new \Drupal\rest\LinkManager\LinkManager($this->get('rest.link_manager.type'), $this->get('rest.link_manager.relation'));
    }
    ...
    {
        return $this->services['rest.link_manager.relation'] = new \Drupal\rest\LinkManager\RelationLinkManager($this->get('cache.default'), $this->get('entity.manager'));
    }
    ...
    {
        return $this->services['rest.link_manager.type'] = new \Drupal\rest\LinkManager\TypeLinkManager($this->get('cache.default'));
    }
    ...
    {
        return $this->services['rest.resource_routes'] = new \Drupal\rest\Routing\ResourceRoutes($this->get('plugin.manager.rest'), $this->get('config.factory'));
    }

    /**
     * Gets the 'restui.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Drupal\restui\RestUIManager A Drupal\restui\RestUIManager instance.
     */
    protected function getRestui_ManagerService()
    {
        return $this->services['restui.manager'] = new \Drupal\restui\RestUIManager($this->get('entity.manager'));
    }
    ...
    {
        return $this->services['serialization.entity_resolver.target_id'] = new \Drupal\serialization\EntityResolver\TargetIdResolver();
    }
    ...
    {
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => $this->get('serializer.normalizer.file_entity.hal'), 1 => $this->get('serializer.normalizer.entity_reference_item.hal'), 2 => $this->get('serializer.normalizer.field_item.hal'), 3 => $this->get('serializer.normalizer.field.hal'), 4 => $this->get('serializer.normalizer.entity.hal'), 5 => $this->get('serializer.normalizer.config_entity'), 6 => $this->get('serializer.normalizer.entity'), 7 => $this->get('serializer.normalizer.complex_data'), 8 => $this->get('serializer.normalizer.list'), 9 => $this->get('serializer.normalizer.typed_data')), array(0 => $this->get('serializer.encoder.hal'), 1 => $this->get('serializer.encoder.json'), 2 => $this->get('serializer.encoder.xml')));
    }
    ...
    {
        return $this->services['serializer.encoder.hal'] = new \Drupal\hal\Encoder\JsonEncoder();
    }
    ...
    {
        return $this->services['serializer.encoder.json'] = new \Drupal\serialization\Encoder\JsonEncoder();
    }
    ...
    {
        return $this->services['serializer.encoder.xml'] = new \Drupal\serialization\Encoder\XmlEncoder();
    }
    ...
    {
        return $this->services['serializer.entity_resolver'] = new \Drupal\serialization\EntityResolver\ChainEntityResolver(array(0 => $this->get('serializer.entity_resolver.uuid'), 1 => $this->get('serialization.entity_resolver.target_id')));
    }
    ...
    {
        return $this->services['serializer.entity_resolver.uuid'] = new \Drupal\serialization\EntityResolver\UuidResolver($this->get('entity.manager'));
    }
    ...
    {
        return $this->services['serializer.normalizer.complex_data'] = new \Drupal\serialization\Normalizer\ComplexDataNormalizer();
    }
    ...
    {
        return $this->services['serializer.normalizer.config_entity'] = new \Drupal\serialization\Normalizer\ConfigEntityNormalizer($this->get('entity.manager'));
    }
    ...
    {
        return $this->services['serializer.normalizer.entity'] = new \Drupal\serialization\Normalizer\EntityNormalizer($this->get('entity.manager'));
    }
    ...
    {
        return $this->services['serializer.normalizer.entity.hal'] = new \Drupal\hal\Normalizer\ContentEntityNormalizer($this->get('rest.link_manager'), $this->get('entity.manager'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['serializer.normalizer.entity_reference_item.hal'] = new \Drupal\hal\Normalizer\EntityReferenceItemNormalizer($this->get('rest.link_manager'), $this->get('serializer.entity_resolver'));
    }
    ...
    {
        return $this->services['serializer.normalizer.field.hal'] = new \Drupal\hal\Normalizer\FieldNormalizer();
    }
    ...
    {
        return $this->services['serializer.normalizer.field_item.hal'] = new \Drupal\hal\Normalizer\FieldItemNormalizer();
    }
    ...
    {
        return $this->services['serializer.normalizer.file_entity.hal'] = new \Drupal\hal\Normalizer\FileEntityNormalizer($this->get('entity.manager'), $this->get('http_client'), $this->get('rest.link_manager'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['serializer.normalizer.list'] = new \Drupal\serialization\Normalizer\ListNormalizer();
    }
    ...
    {
        return $this->services['serializer.normalizer.typed_data'] = new \Drupal\serialization\Normalizer\TypedDataNormalizer();
    }
    ...
    {
        return $this->services['twig.loader.filesystem'] = new \Twig_Loader_Filesystem('/Users/arvinsingla/Sites/dev/ibeacon');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'restui' => array(
                    'type' => 'module',
                    'pathname' => 'modules/contrib/restui/restui.info.yml',
                    'filename' => 'restui.module',
                ),
                'serialization' => array(
                    'type' => 'module',
                ...
                'minimal' => array(
                    'type' => 'profile',
                    'pathname' => 'core/profiles/minimal/minimal.info.yml',
                    'filename' => 'minimal.profile',
                ),
            ),
            'container.namespaces' => array(
                'Drupal\\block' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/block/src',
                'Drupal\\basic_auth' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/basic_auth/src',
                'Drupal\\breakpoint' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/breakpoint/src',
                'Drupal\\config' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/config/src',
                'Drupal\\datetime' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/datetime/src',
                'Drupal\\dblog' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/dblog/src',
                'Drupal\\entity' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/entity/src',
                'Drupal\\entity_reference' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/entity_reference/src',
                'Drupal\\field' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/field/src',
                'Drupal\\field_ui' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/field_ui/src',
                'Drupal\\file' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/file/src',
                'Drupal\\filter' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/filter/src',
                'Drupal\\hal' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/hal/src',
                'Drupal\\image' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/image/src',
                'Drupal\\link' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/link/src',
                'Drupal\\menu_link' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/menu_link/src',
                'Drupal\\node' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/node/src',
                'Drupal\\options' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/options/src',
                'Drupal\\rest' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/rest/src',
                'Drupal\\restui' => '/Users/arvinsingla/Sites/dev/ibeacon/modules/contrib/restui/src',
                'Drupal\\serialization' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/serialization/src',
                'Drupal\\system' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/system/src',
                'Drupal\\text' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/text/src',
                'Drupal\\toolbar' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/toolbar/src',
                'Drupal\\update' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/update/src',
                'Drupal\\user' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/user/src',
                'Drupal\\views' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/views/src',
                'Drupal\\views_ui' => '/Users/arvinsingla/Sites/dev/ibeacon/core/modules/views_ui/src',
                'Drupal\\minimal' => '/Users/arvinsingla/Sites/dev/ibeacon/core/profiles/minimal/src',
                'Drupal\\Core\\Entity' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/Entity',
                'Drupal\\Core\\Field' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/Field',
                'Drupal\\Core\\Mail' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/Mail',
                'Drupal\\Core\\TypedData' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/TypedData',
                'Drupal\\Core\\Validation' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Core/Validation',
                'Drupal\\Component\\Annotation' => '/Users/arvinsingla/Sites/dev/ibeacon/core/lib/Drupal/Component/Annotation',
            ),
